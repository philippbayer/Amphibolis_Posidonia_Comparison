...
```{r}
sink('data/Lost_present_gene_lists/Genes_only_in_Terrestrials.txt')
cat(genes_only_in_terrestrials, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_Seagrasses.txt')
cat(genes_only_in_seagrasses, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_Aquatics.txt')
cat(genes_only_in_aquatics, sep='\n')
sink()


sink('data/Lost_present_gene_lists/Genes_only_in_Aquatics_and_Seagrasses.txt')
cat(genes_only_in_aquatics_and_seagrasses, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_union_of_Seagrass_and_Aquatics_union.txt')
cat(genes_present_seagrass_and_aquatics_union, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_Aquatics_and_Seagrasses_and_Terrestrials.txt')
cat(genes_in_all, sep='\n')
sink()
...
```{r}
sink('data/Lost_present_gene_lists/Genes_only_in_A_antarctica_not_other_seagrasses.txt')
cat(genes_only_in_A_antarctica, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_P_australis_not_other_seagrasses.txt')
cat(genes_only_in_P_australis, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_Z_marina_not_other_seagrasses.txt')
cat(genes_only_in_Z_marina, sep='\n')
sink()

sink('data/Lost_present_gene_lists/Genes_only_in_Z_muelleri_not_other_seagrasses.txt')
cat(genes_only_in_Z_muelleri, sep='\n')
sink()
