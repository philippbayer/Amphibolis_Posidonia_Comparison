...
```{r fig.width=8, fig.height=10}
sum2 <- seagrass_venn / (plot_list$GO_results_genes_union_Aquatics_and_Seagrasses_NOT_Terrestrials.csv + theme(legend.position="bottom")) +  plot_annotation(tag_levels = 'A') +plot_layout(heights=c(1.5,1))
sum2
